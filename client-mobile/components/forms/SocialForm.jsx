...
const SocialForm = ({ isVisible, onClose }) => {
      ...
      >
        <ScrollView>
          <View className="flex-row justify-between items-center mb-4">
            ...
            <Text className="text-xl text-black font-pbold pr-2">Social</Text>
            <TouchableOpacity>
          ...
          <View className="bg-white rounded-xl p-4 space-y-2 mb-3 mt-6">
            ...
            <View className="flex-row justify-between items-center border-b border-gray-300 pb-2 mb-3">
            <Text className="text-lg font-sfbold text-gray-400">Nicotine</Text>
              <TextInput
                placeholder="Always"
            ...
            <View className="flex-row justify-between items-center border-b border-gray-300 pb-2 mb-3">
            <Text className="text-lg font-sfbold text-gray-400">Alcohol</Text>
              <TextInput
                placeholder="Always"
                onFocus={closeDatePicker}
                className="text-lg font-sfbold flex-1"
            ...
            <View className="flex-row justify-between items-center border-b border-gray-300 pb-2 mb-3">
            <Text className="text-lg font-sfbold text-gray-400">Diet</Text>
              <TextInput
                placeholder="Always"
                onFocus={closeDatePicker}
                className="text-lg font-sfbold flex-1"
            ...
            <View className="flex-row justify-between items-center border-b border-gray-300 pb-2 mb-3">
            <Text className="text-lg font-sfbold text-gray-400">Drug</Text>
              <TextInput
                placeholder="Always"
                onFocus={closeDatePicker}
                className="text-lg font-sfbold flex-1"
            ...
            <Text className="text-lg font-sfbold text-gray-400">Physical Activity</Text>
              <TextInput
                placeholder="Rarely"
                onFocus={closeDatePicker}
                className="text-lg font-sfbold flex-1"
