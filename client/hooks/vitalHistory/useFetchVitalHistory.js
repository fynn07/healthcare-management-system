...
async function fetchVitalHistory(page = 1) {
    ...
    try {
        ...
        const response = await fetch(`${ENDPOINT}/api/patient/fetch/${id}/vital_history/?page=${page}`, {
            method: 'GET',
            headers: {
...
// TODO: add function to fetch vital record either added by you or added by all
const btnAll = document.getElementById('btn-vital-by-all');
const btnYou = document.getElementById('btn-vital-by-you');
...
btnAll.addEventListener('click', () => {
    ...
    console.log('Showing vital added by all.');
});
...
btnYou.addEventListener('click', () => {
    ...
    console.log('Showing vital added by you.');
});
